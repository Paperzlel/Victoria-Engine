...
u8 DisplayManagerX11::create_window(const String &p_name, u16 x, u16 y, u16 width, u16 height, WindowFlags p_flags) {
    ...
    | EnterWindowMask | LeaveWindowMask | ExposureMask | StructureNotifyMask | PropertyChangeMask;
...
/**
 * @brief The core processing point of the current window. Any events that occur within the window will refer to this point of the application.
 */
...
/**
 * @brief The "shutdown" routine of the application. Stops all processing, clears out any windows that may still exist, and closes the X11 display.
 */
...
/**
 * @brief Class constructor for the X11 display server. Opens an X11 conntect, gets the screen and its ID, as well as calling the OpenGL manager to
