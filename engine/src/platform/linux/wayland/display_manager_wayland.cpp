...
void DisplayManagerWayland::_on_registry_global(void *p_data, struct wl_registry *p_registry, u32 p_name, const char *p_interface, u32 p_version) {
...
void DisplayManagerWayland::_on_xdg_toplevel_configure(void *p_data, struct xdg_toplevel *p_toplevel, i32 width, i32 height, struct wl_array *p_states) {
...
void DisplayManagerWayland::_on_zxdg_decoration_manager_configure(void *p_data, struct zxdg_toplevel_decoration_v1 *p_decor, u32 p_mode) {
...
u8 DisplayManagerWayland::create_window(const String &p_name, u16 x, u16 y, u16 width, u16 height, WindowFlags p_flags) {
    wd = vnew(WindowData);
    ...
    if (client_data->decor_manager) {
         wd->toplevel_decoration = zxdg_decoration_manager_v1_get_toplevel_decoration(client_data->decor_manager, wd->toplevel);
