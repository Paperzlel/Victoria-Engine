...
/**
 * @brief Prints a message into the console. This version formats the message to appear with some colour to indicate if
...
/**
 * @brief Prints a formatted error message into the console. This version uses some colours to make the message appear
 ...
 */
void LinuxLogger::log_error(const char *file,
							const char *function,
							int line,
							const char *err_msg,
