...
void Font::set_font_size(u32 p_size) {
	font_size = p_size;
}

u32 Font::get_max_font_height() const {
	return max_font_height;
}

void Font::set_max_font_height(u32 p_height) {
	max_font_height = p_height;
}

u32 Font::get_font_baseline_offset() const {
	return font_baseline_offset;
}
void Font::set_font_baseline_offset(u32 p_offset) {
	font_baseline_offset = p_offset;
}

u32 Font::get_bitmap_size() const {
	return bitmap_size;
}

void Font::set_bitmap_size(u32 p_size) {
	bitmap_size = p_size;
}
