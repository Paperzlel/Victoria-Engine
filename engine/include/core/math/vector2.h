...
public:
     ...
     */
    FORCE_INLINE Vector2(const Vector2 &p_other) { *this = p_other; }
 ...
 * their lengths suggests an angle of 0, a value of zero suggest an angle of PI / 2, and a value equal to the negative product of their lengths suggests an angle of PI, and so on. Angles are clamped between -PI and PI, as the method looks for the smallest possible angle between the two.
