...
/**
 * @brief Struct that represents a quaternion, which is primarily used for axis-angle rotations in 3D space. In our implementation, the w component of 
 * the quaternion represents the angle, as the x, y and z components are used for 3D space, so bear that in mind when converting between the two.
 */
