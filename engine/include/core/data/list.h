...
public:
    ...
    struct Iterator {
        FORCE_INLINE T &operator*() const { return e->get(); }
        FORCE_INLINE T *operator->() const { return &e->get(); }
    ...
    struct ConstIterator {
        FORCE_INLINE const T &operator*() const { return e->get(); }
        FORCE_INLINE const T *operator->() const { return &e->get(); }
        ...
        FORCE_INLINE bool operator==(const ConstIterator &p_other) const { return e == p_other.e; }
        FORCE_INLINE bool operator!=(const ConstIterator &p_other) const { return e != p_other.e; }

        ConstIterator(const Element *p_E) { e = p_E; }
        ConstIterator() {}
        ConstIterator(const ConstIterator &p_iter) { e = p_iter.e; }
    ...
    FORCE_INLINE u64 size() const { return element_count; }
