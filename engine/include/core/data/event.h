...
/**
 * @brief The basic event class. This class is designed so that when a given situation occurs, several callback methods can happen at once, allowing for a transfer of communication between two parts of the application that may not otherwise be able to contact one another. Uses a variatic argument template in order for events to have any given amount of arguments to oneself.
 */
