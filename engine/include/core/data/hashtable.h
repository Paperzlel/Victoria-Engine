...
class HashTable {
    ...
    KeyValue<TKey, TValue> * _insert_element(u32 p_hash, const KeyValue<TKey, TValue> &p_value, u32 p_table_size) {
        ...
        while (true) {
            ...
            u32 probe_dist = _get_probe_distance(hashes[idx], idx);
...
public:
    ...
    FORCE_INLINE bool is_empty() const { return element_count == 0; }
    FORCE_INLINE u32 get_element_count() const { return element_count; }
