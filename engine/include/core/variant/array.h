...
public:
    ...
    struct ConstIterator {
        ...
        FORCE_INLINE bool operator==(const ConstIterator &p_other) const { return _p == p_other._p; }
        FORCE_INLINE bool operator!=(const ConstIterator &p_other) const { return _p != p_other._p; }

        FORCE_INLINE ConstIterator(const Variant *p_element_ptr) { _p = p_element_ptr; }
        FORCE_INLINE ConstIterator() {}
        FORCE_INLINE ConstIterator(const ConstIterator &p_other) { _p = p_other._p; }
    private:
