#pragma once
/**
 * The base class for our renderer. All actions that involve rendering something to a screen go through here, from
 * materials to vertices. Since the actual application of most of this code varies depending on if it's using OpenGL or
 * Vulkan, we create a virtual class like this one to abstract out all of the actual processing done.
 */
...
public:
	...
	virtual void
	item_set_texture_rect(RID p_item, RID p_texture, const Vector2 &p_position, const Vector2 &p_size) = 0;
	...
	virtual void texture_set_from_data(RID p_texture,
									   ...
									   TextureMask p_mask = MASK_DEFAULT) = 0;
