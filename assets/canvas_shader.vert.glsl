...
out flat int instance_data_flags;
...
void main() {
    ...
    mat4 model_matrix = mat4(vec4(transform_basis.xy, 0.0, 0.0), vec4(transform_basis.zw, 0.0, 0.0), vec4(0.0, 0.0, 1.0, 0.0), vec4(input_vertex, 0.0, 1.0));
