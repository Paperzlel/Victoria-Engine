#include "platform/linux/wayland/keyboard_remapping_xkb.h"

#if defined(PLATFORM_LINUX) && defined(WAYLAND_ENABLED)

HashTable<xkb_keycode_t, Key, KeyboardRemappingXKB::HashTableKeyHasher> KeyboardRemappingXKB::scancode_map;
HashTable<Key, xkb_keycode_t, KeyboardRemappingXKB::HashTableKeyHasher> KeyboardRemappingXKB::inv_scancode_map;

void KeyboardRemappingXKB::initialize() {
...
xkb_keycode_t KeyboardRemappingXKB::get_xkb_keycode_from_key(Key p_key) {
...
Key KeyboardRemappingXKB::get_key_from_xkb_keycode(xkb_keycode_t p_xkb_key) {
